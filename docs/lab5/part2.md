 ...
 **EXT2** 是GNU/Linux系统中标准的文件系统，其特点是 **存取文件的性能较好** ，对于中小型的文件更显示其优势（因为EXT2不考虑日志）。后续的EXT3和EXT4文件系统就是在EXT2文件系统的基础上发展而来。有兴趣深入了解ext2文件系统的同学，可以参考[EXT2文件系统](https://www.nongnu.org/ext2-doc/ext2.html)。
